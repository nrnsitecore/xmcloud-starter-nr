...
const HeroSectionVariant = (props: HeroSectionProps): JSX.Element => {
    console.log(props);
  return (
    <section className="relative bg-gradient-to-br from-background to-accent/20 py-20 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
export const Default = withDatasourceCheck()<HeroSectionProps>(HeroSection);
export const NoIcons = withDatasourceCheck()<HeroSectionProps>(HeroSectionVariant);