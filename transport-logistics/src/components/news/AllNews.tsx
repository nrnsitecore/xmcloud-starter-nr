...
import { NewsDetail } from 'src/types/NewsDetail';
...
type AllNewsProps = ComponentProps & {
  fields: {
    items: NewsDetail[];
  };
};

const AllNews = (props: AllNewsProps): JSX.Element => {
...
export const Default = withDatasourceCheck()<AllNewsProps>(AllNews);
